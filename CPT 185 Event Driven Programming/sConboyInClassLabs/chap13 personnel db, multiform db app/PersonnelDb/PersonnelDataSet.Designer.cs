...
namespace PersonnelDb {
    ...
    public partial class PersonnelDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string Name, string Position, int HourlyRate) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int HourlyRate {
                get {
                    return ((int)(this[this.tableTable.HourlyRateColumn]));
                }
                set {
                    this[this.tableTable.HourlyRateColumn] = value;
                }
            }
        }
...
namespace PersonnelDb.PersonnelDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name" +
                "] = @Original_Name) AND ([Position] = @Original_Position) AND ([HourlyRate] = @O" +
                "riginal_HourlyRate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Position], [HourlyRate]) VALUES (@Name, @Posi" +
                "tion, @HourlyRate);\r\nSELECT EmployeeID, Name, Position, HourlyRate FROM [Table] " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Name] = @Name, [Position] = @Position, [HourlyRate] = @HourlyRate WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([HourlyRate] = @Original_HourlyRate));
SELECT EmployeeID, Name, Position, HourlyRate FROM [Table] WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PersonnelDb.Properties.Settings.Default.PersonnelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Name, Position, HourlyRate FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Name, string Original_Position, int Original_HourlyRate) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_HourlyRate));
        ...
        public virtual int Insert(string Name, string Position, int HourlyRate) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(HourlyRate));
        ...
        public virtual int Update(string Name, string Position, int HourlyRate, int Original_EmployeeID, string Original_Name, string Original_Position, int Original_HourlyRate, int EmployeeID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(HourlyRate));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_HourlyRate));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, int HourlyRate, int Original_EmployeeID, string Original_Name, string Original_Position, int Original_HourlyRate) {
            return this.Update(Name, Position, HourlyRate, Original_EmployeeID, Original_Name, Original_Position, Original_HourlyRate, Original_EmployeeID);
        }
    }
