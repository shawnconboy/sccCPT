...
namespace databaseCreation.PhonelistDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([PersonID] = @Original_PersonID) AND ([Name] =" +
                " @Original_Name) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Ori" +
                "ginal_Phone)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [Name] = @Name, [Phone] = @Phone WHERE (([PersonID] = @Original_PersonID) AND ([Name] = @Original_Name) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT PersonID, Name, Phone FROM Person WHERE (PersonID = @PersonID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::databaseCreation.Properties.Settings.Default.PhonelistConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT PersonID, Name, Phone FROM dbo.Person where PersonID > 5";
        ...
        public virtual int FillBy(PhonelistDataSet.PersonDataTable dataTable) {
        ...
        public virtual PhonelistDataSet.PersonDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            PhonelistDataSet.PersonDataTable dataTable = new PhonelistDataSet.PersonDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
